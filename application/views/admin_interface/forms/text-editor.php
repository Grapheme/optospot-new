		...
		<div id="ProductTabContent" class="tab-content">
			<div class="tab-pane fade in active" id="main">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea rows="8" class="span14" name="description"><?=$page['description'];?></textarea>
					</div>
				</div>
				<div class="control-group">
					<label for="link" class="control-label">Page link: </label>
					<div class="controls">
						<input type="text" class="span14 valid-required" name="link" value="<?=$page['link'];?>">
					</div>
				</div>
				<div class="control-group">
					<label for="url" class="control-label">Page URL: </label>
					<div class="controls">
						<input type="text" class="span14 valid-required" name="url" <?=(!$page['manage'])?'readonly="readonly"':'';?> value="<?=$page['url'];?>">
						<?php if(!$page['manage']):?>
