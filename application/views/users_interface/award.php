	...
	<div class="container_12">
		...
		<div class="award-block-left">
			<div class="normal-text award-text" style="margin-top: 0;">
				Бинарные опционы – это один из самых быстрых и эффективных способов заработка в Интернете, не требующий быть асом в мире биржевого рынка или какой-либо профессиональной подготовки. Торговля опционами не требует больших стартовых вложений, но позволяет быстро заработать на финансовых изменениях фондовых рынков. Желание выиграть крупную сумму за короткий срок людей влечет на финансовые торги. К сожалению, с таким большим количеством брокеров, которые предлагают сегодня свои услуги для торговли бинарными опционами, тяжело выбрать надежную компанию для торговли на рынке.
			</div>
			<img src="<?=baseURL('img/award-photo-1.png');?>" style="width: 130%; margin-left: -30%;">
		...
		<div class="award-block-right">
			<img src="<?=baseURL('img/award-photo-2.png');?>" style="width: 130%; margin-right: -30%;">
