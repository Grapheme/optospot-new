				...
				<div id="stable">
					...
					<?php if($cntunit['delivers']['total']):?>
						<div class="panel_segment">
							...
							<img src="<?=$this->baseURL;?>images/panel_pic1.jpg">
							<div class="text">
					...
					<?php if((($cntunit['platforms'] || $cntunit['markets']) && $userinfo['remote']) || (!$userinfo['locked'] && !$userinfo['remote'])):?>
						<div class="panel_segment">
							...
							<img src="<?=$this->baseURL;?>images/panel_pic2.jpg">
							<div class="text">
					...
					<?php endif;?>
						<div class="panel_segment">
							...
							<img src="<?=$this->baseURL;?>images/panel_pic3.jpg">
							<div class="text">
						...
						<div class="panel_segment">
							...
							<img src="<?=$this->baseURL;?>images/panel_pic4.jpg">
							<div class="text">
					...
					<?php if(!$userinfo['locked'] && $cntunit['platforms']):?>
						<div class="panel_segment">
							...
							<img src="<?=$this->baseURL;?>images/panel_pic5.jpg">
							<div class="text">
					...
					<?php if($userinfo['remote'] && !$userinfo['locked']):?>
						<div class="panel_segment">
							...
							<img src="<?=$this->baseURL;?>images/panel_pic6.jpg">
							<div class="text">
