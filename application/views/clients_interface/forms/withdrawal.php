<form action="<?=site_url('cabinet/withdraw/request');?>" class="signup-form form-signup" method="post" target="signup_iframe">
	...
	<input type="text" class="valid-required valid-numeric" name="summa" value="1000" placeholder="<?=$this->localization->getLocalPlaceholder('withdraw','summa')?>" />
	<textarea name="details" class="valid-required" placeholder="<?=$this->localization->getLocalPlaceholder('withdraw','details')?>"></textarea>
	<select name="payment">
