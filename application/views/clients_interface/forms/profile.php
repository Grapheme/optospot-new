		...
		<div id="ProductTabContent" class="tab-content">
			...
			<div class="tab-pane fade in" id="address">
				<div class="form-container">
					<div class="control-group">
						<div class="controls">
							<textarea placeholder="<?=$this->localization->getLocalButton('form_profile','address1_lable')?>" rows="1" class="span14" autocomplete="off" name="address1"><?=$account['address1'];?></textarea>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							<textarea placeholder="<?=$this->localization->getLocalButton('form_profile','address2_lable')?>" rows="1" class="span14" autocomplete="off" name="address2"><?=$account['address2'];?></textarea>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
