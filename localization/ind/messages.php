<?php
	...
	$localize = array(
		...
		'index' => array(
			...
			'circle_step1_2' => 'Pada arah mana harga akan<br>bergerak : NAIK atau TURUN.',
			'circle_step2_1' => 'Melakukan Transaksi Trading',
			'circle_step2_2' => 'Potensi profit Anda dapat diketahui lebih dulu.',
			'circle_step3_1' => 'DAPATKAN PROFIT',
			'circle_step3_2' => 'Profit 70 % hanya dalam beberapa menit.',
			'screen1_1' => 'CARA CEPAT DAN MUDAH UNTUK MENDAPATKAN DUNIA TRADING ONLINE',
			'screen1_2' => 'SELURUH PERALATAN UNTUK TRADING BINARY OPTION DENGAN PERCAYA DIRI',
			'screen1_3' => 'MUNGKIN PLATFORM TRADING PALING CANGGIH DENGAN FUNGSI SATU SENTUHAN',
			'screen2_1' => 'Membuka rekening hari ini',
			...
			'fish2_2' => 'Anda memperoleh kesempatan untuk mengurangi resiko dan menggunakan strategi special yang tidak bergantung pada perubahan mendadak pada situasi di market.',
			'fish3_1' => 'TRADER PROFESSIONAL',
			'fish3_2' => 'Dapat melakukan membendung resiko mereka pada posisi terbuka di market regular. Trading dengan resiko minimal, bahkan pada saat dirilisnya beritaberita ekonomi utama',
			'money_right' => 'Cara Trading',
			'money_right1_1' => 'Kirim FORECAST',
			'money_right1_2' => 'Pada arah mana harga akan bergerak : NAIK atau TURUN.',
			'money_right2_1' => 'Melakukan Transaksi Trading',
			'money_right2_2' => 'Potensi profit Anda dapat diketahui lebih dulu.',
			'money_right3_1' => 'DAPATKAN PROFIT',
			'money_right3_2' => 'Profit 70 % hanya dalam beberapa menit.',
		...
		'trade' => array(
			...
			Jika mengalami kesulitan - Mohon install <span class="normal-text"><a href="http://www.java.com/download" target="_blank">Java versi terbaru</a></span>.</br>
			<span style="color: #ADABAB;">Tidak semua browser dapat menggunakan plugin ini.</span>',
